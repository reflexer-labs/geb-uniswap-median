...
contract UniswapV2Library {
    ...
    function quote(uint amountA, uint reserveA, uint reserveB) virtual public pure returns (uint amountB) {
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut) virtual public pure returns (uint amountOut) {
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) virtual public pure returns (uint amountIn) {
    ...
    function getAmountsOut(address factory, uint amountIn, address[] memory path) virtual public view returns (uint[] memory amounts) {
    ...
    function getAmountsIn(address factory, uint amountOut, address[] memory path) virtual public view returns (uint[] memory amounts) {
        require(path.length >= 2, 'UniswapV2Library: INVALID_PATH');
        amounts = new uint[](path.length);
